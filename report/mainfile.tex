...
\usepackage[ruled, noend, linesnumbered]{algorithm2e}  %noline
\usepackage{multirow} 
\usepackage{csquotes}
...
% hyperref package to display URLs in blue roman font according to Springer's eBook style:
\usepackage{hyperref}
\usepackage{color}
