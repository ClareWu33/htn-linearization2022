...
int main(int argc, char *argv[])
{
       ...
       else if (argc > 4)
       {
              problem = argv[1];
              timing_file = argv[2];
              domain_out_name = argv[3];
              problem_out_name = argv[4];
       }
       else if (argc > 3)
       {
              problem = argv[1];
              timing_file = argv[2];
              string out_name_str = argv[3];
              domain_out_name = "../ipc2020domains/linearized-domains/" + out_name_str + "-TO-domain.hddl";
              problem_out_name = "../ipc2020domains/linearized-problems/" + out_name_str + "-TO.hddl";
       }
       else
       {
              printf("You need to pass in:\n 1) a sas problem file, name of the timings file, and name of the new pddl file (without file extension)\n 2) a sas problem file, name of the timings file, name of new domain file, name of new problem file");
              return 1;
       }
