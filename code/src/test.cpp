...
Model *m = setup_model("parsed/problemrover01.sas"); // Process1(problem);
// bool ***all_pre_eff;
// get_t_pre_eff(52, m, all_pre_eff);
int task = 52;
bool ***all_pre_eff = get_t_pre_eff(task, m);
for (int i = 0; i < 3; i++)
{
